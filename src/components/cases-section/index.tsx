  ...
  <section>
    <div className={tw(`w-full min-h-screen bg-gray-900 relative`)}>
      ...
      <div className={tw(`max-w-7xl mx-4 lg:mx-auto pt-20 lg:pt-40`)}>
        <h1 className={tw(`text-white text-4xl lg:text-7xl font-bold text-center`)}>Sie haben besondere Wünsche?</h1>
        <p className={tw(`text-white text-gray-400 text-center text-xl mt-12`)}>
          Keine Panik - wir bringen jede noch so spezielle Anforderung in Ihrem Teamshop unter!
        </p>
